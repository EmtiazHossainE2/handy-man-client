...
const Footer = () => {
    ...
    return (
        <footer className=" bg-[url('https://i.ibb.co/26xZX8D/footer-bg.png')] bg-cover">
            <footer className="footer p-10  text-base-content lg:flex lg:justify-around text-lg ">
                <div>
                    ...
                    <Link to='/ads' className="link link-hover">Advertisement</Link>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t text-base-content border-base-300">
                ...
                <div className="place-self-center md:place-self-center md:justify-self-end">
