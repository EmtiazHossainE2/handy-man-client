...
const UserRow = ({ user, index, refetch }) => {
    ...
    const makeAdmin = () => {
        const url = `https://safe-hamlet-60048.herokuapp.com/user/admin/${email}`
        Swal.fire({
    ...
    const makeUser = () => {
        const url = `https://safe-hamlet-60048.herokuapp.com/user/user/${email}`
        Swal.fire({
    ...
    const handleDelete = () => {
        const url = `https://safe-hamlet-60048.herokuapp.com/user/${email}`;
        Swal.fire({
